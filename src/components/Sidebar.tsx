...
export default function Sidebar({ state, ...actions }: Props) {
  return (
    <div
      data-testid="sidebar"
      className="absolute top-[calc(100%/11)] left-[calc(100%/11)] w-[calc(100%*9/11)] h-[calc(100%*9/11)] flex flex-col items-center gap-1 p-2 overflow-y-auto z-[5] bg-bg-main/92 rounded"
    >
